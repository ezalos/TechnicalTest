...
class DBpedia:
	...
	#This function downloads the webpage with request
		#it then decodes it as a Json and sends it to go_through_attributes
	...
	#This function will save scrapped text in structured data if they
	#are directly relevant to the city (Otherwise you get link to
